...
function EditProfilePage({
  ...
  console.log("EditProfilePage rendered", { adminView, targetSponsorId });
    ...
    const loadProfile = async () => {
      ...
      try {
        ...
        const restOperation = get({
          ...
          path: `/admin/drivers/${encodeURIComponent(targetSponsorId)}`,
          options: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(t("Sponsor profile updated successfully!"));
    } catch (error) {
  ...
  return (
    <Container className="mt-4">
      <div style={{ position: "relative", minHeight: "100vh", padding: "40px" }}>
        <h1 style={{ fontSize: "60px", fontWeight: "bold" }}>{adminView ? "Edit Sponsor Account" : "Edit Profile"}</h1>
        <div style={{ position: "relative", minHeight: "100vh", padding: "40px" }}>
        {adminView && (

    ...
    <Container className="mt-4">
      <div style={{ position: 'relative', minHeight: '100vh', padding: '40px' }}>
        <h1 style={{ fontSize: '60px', fontWeight: 'bold' }}>
          {adminView ? t('editProfile.editDriverAccountTitle') : t('editProfile.title')}
        </h1>

        {adminView && (
          <Alert style={{ backgroundColor: '#10b981', color: 'white', border: 'none' }}>
            <strong>*** {t('editProfile.adminViewAlert')}</strong> {targetDriverId}
            <strong>{' ***'}</strong>
          </Alert>
        )}
          ...
          <Form onSubmit={handleSubmit}>
            <Form.Group as={Row} className="mb-3">
              <Form.Label column sm={3}>
                <strong>{t('editProfile.fullName')}</strong>
              </Form.Label>
              <Col sm={6}>
            ...
            <Form.Group as={Row} className="mb-3">
              <Form.Label column sm={3}>
                <strong>{t('editProfile.preferredName')}</strong>
              </Form.Label>
              <Col sm={6}>
                <Form.Control
                  name="authNickname"
            ...
            <Form.Group as={Row} className="mb-3">
              <Form.Label column sm={3}>
                <strong>{t('editProfile.phoneNumber')}</strong>
              </Form.Label>
              <Col sm={6}>
                <Form.Control
                  name="authPhoneNum"
            ...
            <Form.Group as={Row} className="mb-3">
              <Form.Label column sm={3}>
                <strong>{t('editProfile.email')}</strong>
              </Form.Label>
              <Col sm={6}>
                <Form.Control
                  name="authEmail"
            ...
            <Form.Group as={Row} className="mb-3">
              <Form.Label column sm={3}>
                <strong>{t('editProfile.role')}</strong>
              </Form.Label>
            ...
            {isDriver && !adminView && (
              <>
                ...
                <Form.Group as={Row} className="mb-3">
                  <Form.Label column sm={3}><strong>License Number</strong></Form.Label>
                  <Col sm={6}>
                    <Form.Control
                      name="licenseNo"
                ...
                <Form.Group as={Row} className="mb-3">
                  <Form.Label column sm={3}><strong>License Expiration Date</strong></Form.Label>
                  <Col sm={6}>
                    <Form.Control
                      type="date"
                      name="expDate"
                ...
                <Form.Group as={Row} className="mb-3">
                  <Form.Label column sm={3}><strong>State</strong></Form.Label>
                  <Col sm={6}>
                    <Form.Select
                      name="state"
            ...
            {isSponsor && !adminView && (
              <>
                ...
                <Form.Group as={Row} className="mb-3">
                  <Form.Label column sm={3}><strong>Affiliation / Company Name</strong></Form.Label>
                  <Col sm={6}>
                    <Form.Control
                ...
                <Form.Group as={Row} className="mb-3">
                  <Form.Label column sm={3}><strong>Company Description</strong></Form.Label>
                  <Col sm={6}>
                    <Form.Control
                      as="textarea"
                      rows={4}
            ...
            <Form.Group as={Row} className="mb-3 align-items-center">
              <Form.Label column sm={3}>
                <strong>{t('editProfile.profilePicture')}</strong>
              </Form.Label>
              <Col sm={6}>
            ...
            <Button style={{ width: '160px', height: '50px' }} type="submit">
              Save Changes
            </Button>
          </Form>
        )}
